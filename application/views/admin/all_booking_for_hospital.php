                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="input-group" id="datepicker1">
                                    <input type="text" class="form-control" data-date-format="dd-mm-yyyy" readonly data-date-container='#datepicker1' data-date-autoclose="true" data-provide="datepicker" name="date" value="<?= $date ?>">
                                </div>
                            </div>
                            <div class="col-lg-2">
                            ...
                            <div class="col-lg-2 mr-2">
                                <a href="<?= base_url('assignPartnerForHospital') ?>" class="btn btn-success">Reset</a>
                            </div>
                        </div>
                    </form>
                </div>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><?= $all['hospital_name'] ?></td>
                                                <td><?= $all['hospital_address'] ?></td>
